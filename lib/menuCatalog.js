...
const MENU_CATEGORIES = Object.freeze([
    { key: 'settings', title: 'SETTINGS', commands: ['addowner', 'delowner', 'listowner', 'block', 'unblock', 'blocklist', 'anticall', 'joingc', 'join', 'restart', 'mode', 'edit', 'clearall', 'autobio', 'setpp', 'autoread', 'autotyping', 'autorecording', 'autorecordtype', 'autoviewstatus', 'autoreact', 'autolikestatus', 'chatbot', 'broadcast', 'schedule', 'feedback', 'getsession', 'backup', 'update', 'setmenuimage', 'antidelete', 'setprefix', 'setfullpp', 'reveal', 'listgroup', 'listonline', 'settings', 'gsettings', 'groupsettings', 'setpaypoint', 'setpayment', 'paylink', 'reportcommand'] },
    ...
    { key: 'general', title: 'GENERAL', commands: ['owner', 'menu', 'test', 'alive', 'runtime', 'script', 'donate', 'clearchat', 'delete', 'getpp', 'gemini', 'elevenlab', 'lyrics', 'yts', 'vv', 'getgrouppp', 'panel', 'copy', 'vvdm', '8ballpool', 'bible', 'quran', 'shazam', 'status', 'statusd', 'deploy', 'logs', 'todo', 'remind', 'summary', 'audiospeed', 'eval', 'jid', 'lid', 'tempmail', 'tempinbox', 'poll', 'channel-id', 'group-id', 'pair'] }
]);
