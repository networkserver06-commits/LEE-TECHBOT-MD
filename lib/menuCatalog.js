...
const MENU_CATEGORIES = Object.freeze([
    { key: 'settings', title: 'SETTINGS', commands: ['addowner', 'delowner', 'listowner', 'block', 'unblock', 'blocklist', 'anticall', 'joingc', 'join', 'restart', 'mode', 'edit', 'clearall', 'autobio', 'setpp', 'autoread', 'autotyping', 'autorecording', 'autorecordtype', 'autoviewstatus', 'autoreact', 'autolikestatus', 'chatbot', 'getsession', 'backup', 'update', 'setmenuimage', 'antidelete', 'setprefix', 'setfullpp', 'reveal', 'listgroup', 'listonline', 'settings', 'gsettings', 'groupsettings', 'setpaypoint', 'reportcommand'] },
    ...
    { key: 'img-maker', title: 'IMG MAKER', commands: ['create', 'imagine', 'deepfake'] },
    { key: 'convert', title: 'CONVERT', commands: ['sticker', 'take', 'toimage', 'url', 'get', 'emojimix', 'ssweb', 'tts', 'vocalremover', 'colorize', 'remini', 'translate', 'removebg', 'toviewonce'] },
    { key: 'fun', title: 'FUN', commands: ['readmore', 'define', 'flux', 'tictactoe', 'quotes', 'fact', 'truth', 'google', 'flirt', 'note', 'listnote', 'deletenote', 'insult', 'wasted', 'country', 'telegramsticker', 'rate'] },
    { key: 'downloads', title: 'DOWNLOADS', commands: ['play', 'ytmp3', 'ytmp4', 'mediafire', 'wallpaper', 'hdwallpaper', 'pinterest', 'tiktok', 'instagram', 'facebook', 'img', 'aio', 'fdroid', 'imgsearch', 'song', 'twitter', 'apk', 'spotify', 'spotifysearch', 'gitclone', 'splay', 'nsfw', 'npm', 'knackvideo'] },
...
const CATEGORY_ALIASES = Object.freeze({
    setting: 'settings', group: 'groups', groups: 'groups', image: 'img-maker', images: 'img-maker', convert: 'convert', download: 'downloads', downloads: 'downloads', fun: 'fun', general: 'general', ai: 'ai', anime: 'anime'
});
